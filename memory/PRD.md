...
- **[Feb 2026]** Products tab filter bar redesigned — "All Products" hero header with live product count, modern pill-style Platform (All/Mac/Windows) and Version (All/2024/2021/…) toggles, rounded search pill, sort dropdown (Newest/Oldest/Price asc·desc/Name A→Z/Best Sellers). Secondary filters (Category, Brand, Status, Stock, Region, Price) tucked behind a "More filters" toggle. Added `sort` query param + new ORDER BY logic.
