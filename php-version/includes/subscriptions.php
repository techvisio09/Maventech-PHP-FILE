...
<div style="font-family:-apple-system,Segoe UI,Helvetica,Arial,sans-serif;max-width:620px;margin:0 auto;color:#0f172a">
  ...
  <div style="background:#fff;border:1px solid #e2e8f0;border-top:0;border-radius:0 0 12px 12px;padding:26px;line-height:1.55;">
    <p style="margin:0 0 16px;font-size:14px;">Thank you for subscribing to <strong>{$planNm}</strong>. Your subscription is now active. Your receipt and subscription certificate are attached as PDFs.</p>
    <table style="width:100%;border-collapse:collapse;font-size:13px;margin:4px 0 18px;">
      ...
      <tr><td style="padding:7px 0;color:#64748b;">Tenure</td><td style="padding:7px 0;">{$tenure}</td></tr>
    ...
    <p style="margin:20px 0 0;font-size:12px;color:#94a3b8;">{$brandE} · This is an automated confirmation for your subscription purchase.</p>
  </div>
</div>
HTML;
