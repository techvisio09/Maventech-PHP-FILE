        ...
        <div class="card h-100">
          <div class="card-body">
            ...
            <div class="p-3 rounded mb-3" style="background:#f8fafc;">
              <!-- live preview -->
              <script src="<?= esc($siteUrl) ?>/embed/badge.js" async data-testid="badge-preview-shop"></script>
            </div>
        ...
        <div class="card h-100">
          <div class="card-body">
            ...
            <div class="p-3 rounded mb-3" style="background:#0f172a;">
              <script src="<?= esc($siteUrl) ?>/embed/badge.js" async data-theme="light" data-testid="badge-preview-light"></script>
            </div>
            <label class="small fw-semibold mb-1">Copy &amp; paste:</label>
        ...
        <div class="col-md-6">
          <div class="card h-100">
            <div class="card-body">
              ...
              <div class="p-3 rounded mb-3" style="background:#f8fafc;">
                <script src="<?= esc($siteUrl) ?>/embed/badge.js" async data-product="<?= esc($p['slug']) ?>" data-testid="badge-preview-<?= $i ?>"></script>
              </div>
              <label class="small fw-semibold mb-1">Copy &amp; paste:</label>
...
Every key is delivered to the customer's inbox within 15-30 minutes of purchase, activates online and carries a lifetime
perpetual license — no recurring subscription.  Built for small businesses, IT teams and home users in the US, UK, Canada
and Australia, <?= esc($brand) ?> backs every order with 24/7 support and a 30-day money-back guarantee.</pre>
  ...
  <!-- AFFILIATE CTA -->
  <section class="mb-5" data-testid="press-affiliate">
    <div class="card border-primary">
      <div class="card-body d-flex flex-wrap align-items-center gap-3">
        <div class="flex-grow-1">
          <h2 class="h5 fw-bold mb-1">Earn while you embed</h2>
          <p class="text-secondary mb-0 small">
            Join the <?= esc($brand) ?> affiliate program and your embed badge becomes a revenue
            stream — pre-tagged links, real-time analytics and on-time payouts.
          </p>
        </div>
        <a href="affiliate.php" class="btn btn-primary rounded-pill px-4" data-testid="press-affiliate-cta">
          Join the affiliate program <i class="bi bi-arrow-right ms-1"></i>
        </a>
      </div>
    </div>
  </section>
