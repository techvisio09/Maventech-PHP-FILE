...
<div class="container py-4 py-lg-5" data-testid="brand-profile">
  ...
  <div class="d-flex flex-wrap align-items-center gap-4 mb-4 pb-3 border-bottom" data-testid="brand-hero">
    ...
    <div style="flex:1;min-width:220px;">
      ...
      <div class="d-flex gap-2 flex-wrap" style="font-size:12px;font-weight:600;">
        ...
        <?php if ($avgRating > 0): ?>
          <span style="background:#ecfdf5;color:#047857;border-radius:999px;padding:3px 11px;"><i class="bi bi-star-fill me-1"></i><?= esc($avgRating) ?> · <?= number_format($reviewCount) ?> reviews</span>
        <?php endif; ?>
      </div>
    </div>
  </div>
  ...
  <ul class="nav nav-tabs mb-4" data-testid="brand-tabs">
    ...
    <li class="nav-item">
      <a class="nav-link <?= $active === 'reviews' ? 'active fw-bold' : '' ?>" href="?slug=<?= esc($slug) ?>&view=reviews" data-testid="brand-tab-reviews"><i class="bi bi-chat-quote me-1"></i>Reviews</a>
    </li>
  </ul>
